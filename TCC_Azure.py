...
def Executa_AnaliseSentimentos_Azure():
    ...
    credential = AzureKeyCredential("354eb991c2bd47349e9251765de9346c")
    text_analytics_client = TextAnalyticsClient(endpoint="https://tccfinalteste2309.cognitiveservices.azure.com/",
